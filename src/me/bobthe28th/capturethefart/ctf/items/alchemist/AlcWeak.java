...
public class AlcWeak extends CTFStackCooldownItem {

    PotionEffectType effect = PotionEffectType.WEAKNESS;
    int duration = 100;
    int amplifier = 0;

    public AlcWeak(CTFPlayer player_, Main plugin_, Integer defaultSlot_) {
        super("Weakness Potion", Material.SPLASH_POTION,0,"Weakness Potion",5,Material.GLASS_BOTTLE,player_,plugin_,defaultSlot_);
        setPotionEffect(new PotionData(PotionType.WEAKNESS));
    }
