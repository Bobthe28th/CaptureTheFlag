...
public class AlcSpeed extends CTFStackCooldownItem {

    PotionEffectType effect = PotionEffectType.SPEED;
    int duration = 100;
    int amplifier = 0;

    public AlcSpeed(CTFPlayer player_, Main plugin_, Integer defaultSlot_) {
        super("Swiftness Potion", Material.SPLASH_POTION,0,"Swiftness Potion",5,Material.GLASS_BOTTLE,player_,plugin_,defaultSlot_);
        setPotionEffect(new PotionData(PotionType.SPEED));
    }
