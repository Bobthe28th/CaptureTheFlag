...
public class AlcSlow extends CTFStackCooldownItem {

    PotionEffectType effect = PotionEffectType.SLOW;
    int duration = 100;
    int amplifier = 0;

    public AlcSlow(CTFPlayer player_, Main plugin_, Integer defaultSlot_) {
        super("Slowness Potion", Material.SPLASH_POTION,0,"Slowness Potion",5,Material.GLASS_BOTTLE,player_,plugin_,defaultSlot_);
        setPotionEffect(new PotionData(PotionType.SLOWNESS));
    }
