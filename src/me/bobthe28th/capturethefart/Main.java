...
public class Main extends JavaPlugin implements Listener {
    ...
    public static Class<?>[] CTFClasses = new Class<?>[]{WizardFire.class, WizardIce.class, WizardWind.class, Paladin.class, Demo.class, Builder.class, Archer.class, Assassin.class};
    public static String[] CTFClassNames = new String[]{"WizardFire","WizardIce","WizardWind","Paladin","Demo","Builder","Archer","Assassin"};
