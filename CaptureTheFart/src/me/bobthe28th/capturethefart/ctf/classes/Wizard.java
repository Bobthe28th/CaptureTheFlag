...
public class Wizard extends CTFClass implements Listener {
    ...
    public void giveItems() {
        player.removeItems();
        player.giveItem(new WizBookWind(player,plugin),2);
        player.giveItem(new WizStickWind(player,plugin),1);
        player.giveItem(new WizBookIce(player,plugin),7);
        player.giveItem(new WizStickIce(player,plugin),6);
        player.giveItem(new WizStickFire(player,plugin),4);
    }
